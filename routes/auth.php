...
Route::middleware('guest')->group(function () {
    Route::get('auth/social/{provider}', [SocialController::class, 'redirectToProvider'])->name('auth.social');
    Route::get('auth/social/{provider}/callback', [SocialController::class, 'handleProviderCallback']);
